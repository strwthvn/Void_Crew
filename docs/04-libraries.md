...
**spdlog** — быстрое логирование. В текущей реализации используются синхронные _mt sinks; переход на async logger запланирован на фазу 2, когда дисковый I/O может блокировать игровой цикл. Минимальное влияние на производительность в release-сборках за счёт compile-time отключения TRACE/DEBUG.
